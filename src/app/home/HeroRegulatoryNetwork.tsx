    ...
    <div className="atlas-hero-network-shell" aria-hidden="true">
      ...
      >
        <g className="atlas-network-system">
          <path
            className="atlas-network-line atlas-network-line-1"
            d="M84 116H226L318 54H488"
            pathLength="1"
          />
          <path
            className="atlas-network-line atlas-network-line-2"
            d="M84 116L172 234H318L414 166H558"
            pathLength="1"
          />
          <path
            className="atlas-network-line atlas-network-line-3"
            d="M172 234L250 352H414L558 286"
            pathLength="1"
          />
          <path
            className="atlas-network-line atlas-network-line-4"
            d="M318 54V234L414 352V166"
            pathLength="1"
          />
          <path
            className="atlas-network-line atlas-network-line-5"
            d="M226 116L318 234L488 54L558 166V286"
            pathLength="1"
          />

          <g className="atlas-network-node atlas-network-node-1">
            <circle cx="84" cy="116" r="10" />
            <circle className="atlas-network-node-ring" cx="84" cy="116" r="19" />
          </g>
